...
using IQMetrix.Beertap.Documentation.Controllers;

namespace IQMetrix.Beertap.WebApiInfra
{
    public static class BootStrapper
    {
        private static Assembly _resourceSpecsAssembly;
        private static Assembly _resourceStateProvidersAssembly;
        ...
        static void InitializeDocumentationApplication(HttpConfiguration config, IApiContainer container)
        {
            ...
            const string apiName = "IQMetrix.Beertap API documentation";
