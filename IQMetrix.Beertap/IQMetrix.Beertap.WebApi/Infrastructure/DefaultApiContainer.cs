...
using IQMetrix.Beertap.WebApi.Handlers;
using IQMetrix.Beertap.WebApi.Hypermedia;
using IQMetrix.Beertap.WebApi.Infrastructure.Installers;
using IQMetrix.Beertap.Model;
using IQ.Platform.Framework.WebApi.Infrastructure;
using IQMetrix.Beertap.ApiServices.Provider;

namespace IQMetrix.Beertap.WebApi.Infrastructure
{
